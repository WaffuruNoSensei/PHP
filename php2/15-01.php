  ...
  <body>
        ...
        <form action="15-02.php" method="post">
          <ol>
            ...
            <li>
              Tu pareja ha dejado de subir fotos de pareja a sus redes de repente.<br>
            ...
            <li>
              Suele salir más arreglado/a de lo normal cuando sale con sus amigos/as.<br>
              <input type="radio" name="r4" value="3">verdadero<br>
              <input type="radio" name="r4" value="0">falso<br>
            </li>

            <li>
              No te deja que mires el whatsapp.<br>
